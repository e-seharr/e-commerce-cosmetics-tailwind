...
function Login() {
  ...
  const inputCls = "w-full px-3 py-2.5 border border-[#ffd6e0] dark:border-[#4a2030] rounded-[6px] font-[Poppins,sans-serif] text-[14px] transition-all outline-none focus:border-[#ff6b8a] focus:shadow-[0_0_0_3px_rgba(255,77,109,0.12)] box-border bg-white dark:bg-[#2a1020] text-[#1f1f1f] dark:text-[#f5e6ea]";
  ...
  return (
    <div className="min-h-screen font-[Poppins,sans-serif] bg-[#fff5f9] dark:bg-[#1a0a10] text-[#1f1f1f] dark:text-[#f5e6ea]">
      ...
      <div className="max-w-[480px] mx-auto mt-10 bg-white dark:bg-[#2a1020] p-8 rounded-[15px] shadow-[0_4px_20px_rgba(0,0,0,0.09)] border border-[#ffe0ee] dark:border-[#4a2030]">
        <h2 className="text-[24px] font-semibold mb-2 text-[#1f1f1f] dark:text-[#f5e6ea]">Login 🔐</h2>
        <p className="text-[14px] text-[#444] dark:text-[#d4b8c0] mb-4">Welcome back! Please sign in to your account.</p>
        <form onSubmit={handleLogin}>
          <div className="mb-3.5">
            <label className={labelCls}>Email Address</label>
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your email" required className={inputCls} />
          </div>
          <div className="mb-3.5">
        ...
        <br />
        <p className="text-[14px] text-[#444] dark:text-[#d4b8c0]">Don't have an account? <Link to="/signup" className="text-[#ff6b9d] hover:underline">Register here</Link></p>
      </div>
